...
import BookLoading from "../books/BookLoading";
...
function Profile() {
    ...
    const previewImage = (event) => {
        ...
        //preview in UI
        reader.onload = () => {
            if (reader.readyState === 2) setPreview(reader.result);
        };
